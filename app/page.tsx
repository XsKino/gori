...
const Sidebar = () => {
  return (
    <div className='bg-gray-800 h-full w-1/4 flex flex-col items-center justify-center shadow-lg z-10'>
      ...
      <Button className='bg-blue-500 text-white px-8 py-4 rounded-full mb-4' size='lg'>
        Option 1
      </Button>
      <Button className='bg-green-500 text-white px-8 py-4 rounded-full' size='lg'>
        Option 2
      </Button>
    </div>
  )
    ...
    <div className='flex h-screen bg-black text-white'>
      ...
      <div className='flex flex-col items-start justify-center w-3/4 p-10 relative'>
        ...
        <div className='flex mb-6'>
          <Button className='bg-blue-500 text-white px-8 py-4 rounded-full mr-4' size='lg'>
            Loging
          </Button>
          <Button className='bg-red-800 text-white px-8 py-4 rounded-full' size='lg'>
            Create account
          </Button>
        </div>
        <hr className='w-full border-t border-gray-500 mb-6' />
        <div className='bg-#FA3D3B p-6'>
          <Button className='bg-red-800 text-white px-8 py-4 rounded-full mr-4' size='lg'>
            Maps
          </Button>
          <Button className='bg-blue-500 text-white px-8 py-4 rounded-full mr-4' size='lg'>
            Chacacters
