    ...
    <div
      ...
      <div className='absolute top-0 right-0 m-4 text-right'>
        <div className='flex items-end justify-end'>
          <div className='text-2xl font-bold text-yellow-300 pr-2 mb-6'>{currentCharacter.gender}</div>
          <div className='text-5xl font-bold text-yellow-300 '>{currentCharacter.name}</div>
        </div>
        ...
        <div className='flex'>
          <div className='max-w-[600px] flex items-center justify-center text-center mt-5'>
                  ...
                  case 'Descripcion':
                    return (
                      <div>
                        ...
                        <p className='mt-5 text-left'>{currentCharacter.description}</p>
            ...
            <div className='w-auto flex justify-end'>
              <Listbox variant='shadow' onAction={key => setCurrentAction(key)}>
                ...
                <ListboxItem key='delete' color='warning' className='text-warning'>
                  Jugar
                </ListboxItem>
              </Listbox>
            </div>
